...
export { default as SectionHomepage } from './sections/SectionHomepage/SectionHomepage';
export { default as SectionLogin } from './sections/SectionLogin/sectionLogin';
export { default as SectionVerifyEmail } from './sections/SectionVerifyEmail/sectionVerifyEmail'
export { default as SectionQuoting } from './sections/SectionQuoting/sectionQuoting';
